export default function Privacy() {
  return (
    <main className='duration-200 mt-28 pb-28 md:mt-44 bg-zinc-100 dark:bg-zinc-800'>
      <div className='max-w-screen-xl p-4 mx-auto prose-lg prose-h4:font-semibold prose-h4:text-xl'>
        ...
        <p>
          ...
          dem Abschnitt &bdquo;Hinweis zur Verantwortlichen Stelle&ldquo; in dieser Datenschutzerklärung entnehmen.
        </p>
        ...
        <p>
          ...
          Abs. 1 lit. a DSGVO und &sect; 25 Abs. 1 TTDSG, soweit die Einwilligung die Speicherung von Cookies oder den
        ...
        <h4>Vercel Inc.</h4>
        <p>
          Vercel stellt eine Cloudplattform zur Verfügung, über die unsere Webseite gehostet wird. Das bedeutet, dass
          beim Besuch unserer Webseite die Server von Vercel zur Verarbeitung oder Weiterleitung der Anfragen verwendet
          werden. Im Rahmen des Besuchs auf unserer Webseite erfolgt auch eine Übermittlung der damit verbundenen Daten
          an Vercel. Diese Übermittlung ist erforderlich, um die erfolgreiche Bearbeitung der Browseranfragen zu
          gewährleisten.
        </p>
        <p>
          Vercel Inc.
        ...
        <p>E-Mail: niklas.fischer@mail.de</p>
        <p>
        ...
        <p>
          Wenn Sie die Verarbeitung Ihrer personenbezogenen Daten eingeschränkt haben, dürfen diese Daten &ndash; von
          ihrer Speicherung abgesehen &ndash; nur mit Ihrer Einwilligung oder zur Geltendmachung, Ausübung oder
        ...
        <p>
          ...
          Sie diese selbst löschen oder eine automatische Löschung durch Ihren Webbrowser erfolgt.
        </p>
        <p>
        ...
        <p>
          ...
          ausgeschlossen. So stellt YouTube &ndash; unabhängig davon, ob Sie sich ein Video ansehen &ndash; eine
